[![Build Status](https://app.travis-ci.com/matjutapretty/psql-refresher-workshop.svg?branch=main)](https://app.travis-ci.com/matjutapretty/psql-refresher-workshop)
